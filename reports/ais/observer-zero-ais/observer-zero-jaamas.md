...
26% exhibiting refutation-driven belief revision [6]. **We take this as our starting point rather
...
survey [35] describes **no system in which agents autonomously decide whether to communicate at
...
three-agent chains shows *attenuation* rather than amplification [15, 26], which makes "errors
...
claims presented as *presupposed* rather than asserted are accommodated far more readily [8], a
...
wrong state [1]; complex contagion [7]; and the result that *less* connected communities can
...
| Detector benchmark shows the shift was undetectable in a world | That world reported separately; agent performance not scored against impossible evidence | **Did not fire** — detectable in 42 of 42 gravity_shift runs |
...
final state; *lenient* also accepts world-level natural causes; fault scoring is site-aware. A separate judged pass asks whether each agent committed to a specific onset day and if so
...
160 agent-runs. Summing the homogeneous grounded conditions gives **7,680 agent-days of
...
sparse communication can *help* an epistemic community [3, 40] — itself parameter-dependent [31] — presumes that what flows through the sparse channel is evidence. Here
...
[1] Anderson, L. R. & Holt, C. A. (1997). Information cascades in the laboratory. *American Economic Review*, 87(5), 847–862.

[2] Ashery, A. F., Aiello, L. M. & Baronchelli, A. (2025). Emergent social conventions and collective bias in LLM populations. *Science Advances*, 11(20), eadu9368.

[3] Bala, V. & Goyal, S. (1998). Learning from neighbours. *Review of Economic Studies*, 65(3), 595–621.

[4] Banerjee, A. V. (1992). A simple model of herd behavior. *Quarterly Journal of Economics*, 107(3), 797–817.
...
[14] Imran, S., Kendiukhov, I., Broerman, M., Thomas, A., Campanella, R., Lamb, R. & Atkinson, P. M. (2025). Are LLM belief updates consistent with Bayes' theorem? *ICML 2025 Workshop on Assessing World Models*. arXiv preprint arXiv:2507.17951.
...
[16] Jansen, P., Côté, M.-A., Khot, T., Bransom, E., Dalvi Mishra, B., Majumder, B. P., Tafjord, O. & Clark, P. (2024). DiscoveryWorld: A virtual environment for developing and evaluating automated scientific discovery agents. *Advances in Neural Information Processing Systems 37*, Datasets and Benchmarks Track.
...
[27] O'Connor, C. & Weatherall, J. O. (2019). *The Misinformation Age: How False Beliefs Spread*. New Haven, CT: Yale University Press.

[28] Park, J. S., O'Brien, J. C., Cai, C. J., Morris, M. R., Liang, P. & Bernstein, M. S. (2023). Generative agents: Interactive simulacra of human behavior. *Proceedings of the 36th Annual ACM Symposium on User Interface Software and Technology (UIST '23)*.
...
[31] Rosenstock, S., Bruner, J. & O'Connor, C. (2017). In epistemic networks, is less really more? *Philosophy of Science*, 84(2), 234–252.
...
[35] Yan, B., Zhou, Z., Zhang, L., Zhang, L., Zhou, Z., Miao, D., Li, Z., Li, C. & Zhang, X. (2026). Beyond self-talk: A communication-centric survey of LLM-based multi-agent systems. *Frontiers of Computer Science*.
...
[37] Yang, Z., Zhang, Z., Zheng, Z., Jiang, Y., Gan, Z., Wang, Z., Ling, Z., Chen, J., Ma, M., Dong, B., Gupta, P., Hu, S., Yin, Z., Li, G., Jia, X., Wang, L., Ghanem, B., Lu, H., Lu, C., … Shao, J. (2024). OASIS: Open agent social interaction simulations with one million agents. arXiv preprint arXiv:2411.11581.

[38] Zheng, T., Tam, K. K.-W., Nguyen, N. H.-N. K., Xu, B., Wang, Z., Cheng, J., Tsang, H. T., Wang, W., Bai, J., Fang, T., Song, Y., Wong, G. Y. & See, S. (2026). NewtonBench: Benchmarking generalizable scientific law discovery in LLM agents. *International Conference on Learning Representations (ICLR 2026)*.
...
[40] Zollman, K. J. S. (2007). The communication structure of epistemic communities. *Philosophy of Science*, 74(5), 574–587.
